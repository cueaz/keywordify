...
import { assert, beforeEach, suite, type TestAPI, test } from 'vitest';
import * as K from '~keywords';
import { directive } from '../../src/directive.js';
import { type StyleInfo, styleMap } from '../../src/directives/style-map.js';
import { type AttributePart, html, render } from '../../src/lit-html.js';
...
const testIfSupportsCSSVariables = (test: TestAPI) =>
